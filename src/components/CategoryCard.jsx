...
export default function CategoryCard({ category, navigate }) {
  return (
    ...
    >
      ...
      <div className="relative w-full aspect-[4/5] rounded-t-full rounded-b-[20px] sm:rounded-b-[36px] bg-gradient-to-b from-[#FFF3F6]/55 via-[#FFFBFD]/30 to-white/70 backdrop-blur-xs border border-[#FFC0D3] shadow-[0_5px_15px_rgba(255,182,193,0.12)] flex items-center justify-center p-1 sm:p-2.5 overflow-visible transition-all duration-300 ease-out group-hover:shadow-[0_10px_22px_rgba(255,77,109,0.22)] group-hover:border-[#FF4D6D]">
        ...
        <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 z-20 bg-white/85 backdrop-blur-md border border-[#FFA3C4]/60 px-1 py-1 sm:px-3.5 sm:py-1.5 rounded-full shadow-[0_4px_8px_rgba(255,182,193,0.18)] group-hover:shadow-[0_6px_12px_rgba(255,182,193,0.35)] group-hover:border-[#FF4D6D] group-hover:bg-white transition-all duration-300 min-w-[95%] text-center flex flex-col items-center justify-center gap-0.5">
          <h3 className="text-[6px] min-[360px]:text-[7px] sm:text-[9.5px] font-semibold tracking-[0.04em] text-neutral-800 uppercase font-display leading-none whitespace-nowrap">
            {category.displayName}
          </h3>
          <span className="text-[5px] min-[360px]:text-[6px] sm:text-[7.5px] font-bold text-[#FF4D6D]/75 tracking-widest uppercase leading-none whitespace-nowrap">
            {category.itemsCount}
          </span>
        </div>
      </div>
