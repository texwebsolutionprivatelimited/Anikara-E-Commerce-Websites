...
export default function BottomNav({ currentPage, navigate }) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden border-t border-neutral-200/80 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] bg-white/95 backdrop-blur-md">
      <div className="px-2 py-1.5 pb-[max(0.375rem,env(safe-area-inset-bottom))] flex items-center justify-around">
        {navItems.map((item) => {
