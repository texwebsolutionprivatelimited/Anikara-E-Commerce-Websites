...
const additionalProducts = [
  ...
  },
  {
    ...
    badge: "New Arrival",
    name: "Ultra-Stretch Gym Leggings",
    price: 1899,
    oldPrice: 2499,
    image: "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=600&q=80",
    altImage: "https://images.unsplash.com/photo-1571008887538-b36bb32f4571?auto=format&fit=crop&w=600&q=80",
    rating: 4.8,
    ratingCount: 88,
    sizes: ["S", "M", "L"],
    colors: [{ name: "Onyx Black", hex: "#111111" }],
    description: "Designed for high-performance exercise. Sweat-wicking 4-way stretch fabric with squat-proof thickness and high-waist support.",
    details: ["78% Nylon, 22% Spandex", "Squat-proof compression", "Hidden waistband pocket"],
    reviews: []
  },
  {
    id: "sw2",
    ...
    ratingCount: 39,
    sizes: ["S", "M", "L"],
    colors: [{ name: "Sage Green", hex: "#8DA399" }],
    description: "Medium-support rib-knit sports bra featuring moisture-control lining and removable cup padding.",
    details: ["90% Nylon, 10% Elastane", "Removable padded cups", "Thick elastic underband"],
    reviews: []
  },
  {
    id: "fw1",
    category: "Footwear",
    badge: "Best Seller",
    name: "Minimalist Leather Platform Sneakers",
    price: 3499,
    oldPrice: 4599,
    image: "https://images.unsplash.com/photo-1549298916-b41d501d3772?auto=format&fit=crop&w=600&q=80",
    altImage: "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&w=600&q=80",
    rating: 4.7,
    ratingCount: 112,
    sizes: ["36", "37", "38", "39", "40"],
    colors: [{ name: "Classic White", hex: "#FFFFFF" }],
    description: "Retro tennis-inspired leather sneakers. Clean silhouette, comfortable padded collar, and vulcanized rubber sole.",
    details: ["100% Genuine Leather upper", "Cushioned memory foam footbed", "Platform rubber cupsole"],
    reviews: []
  },
  {
    id: "fw2",
    category: "Footwear",
    badge: "",
    name: "Square-Toe Strappy Sandal Heels",
    price: 2799,
    oldPrice: 3499,
    image: "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&w=600&q=80",
    altImage: "https://images.unsplash.com/photo-1549298916-b41d501d3772?auto=format&fit=crop&w=600&q=80",
    rating: 4.5,
    ratingCount: 26,
    sizes: ["37", "38", "39"],
    colors: [{ name: "Amber Tan", hex: "#B07D62" }],
    description: "Sophisticated strappy sandals with a modern square toe and walkable block heel. Perfect for summer parties or office wear.",
    details: ["Vegan leather straps", "2.5-inch block heel", "Adjustable ankle buckle"],
    reviews: []
  },
  {
    id: "bg1",
    category: "Bags",
    badge: "Premium",
    name: "Classic Pebbled Leather Shoulder Bag",
    price: 3999,
    oldPrice: 4999,
    image: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=600&q=80",
    altImage: "https://images.unsplash.com/photo-1590874103328-eac38a683ce7?auto=format&fit=crop&w=600&q=80",
    rating: 4.9,
    ratingCount: 145,
    sizes: ["One Size"],
    colors: [{ name: "Ruby Red", hex: "#8A1821" }, { name: "Onyx Black", hex: "#111111" }],
    description: "Sleek, structured shoulder bag made of high-quality pebbled cowhide leather. Spacious compartments and golden hardware.",
    details: ["100% Genuine Pebbled Leather", "Zip closure & magnet flap", "Golden chain shoulder strap"],
    reviews: []
  },
  {
    id: "bg2",
    category: "Bags",
    badge: "Hot",
    name: "Minimalist Nylon Crescent Sling",
    price: 1999,
    oldPrice: 2499,
    image: "https://images.unsplash.com/photo-1590874103328-eac38a683ce7?auto=format&fit=crop&w=600&q=80",
    altImage: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=600&q=80",
    rating: 4.7,
    ratingCount: 89,
    sizes: ["One Size"],
    colors: [{ name: "Olive Green", hex: "#5C6B52" }],
    description: "The viral crescent-shaped crossbody bag. Lightweight, water-resistant nylon shell, with plenty of room for daily essentials.",
    details: ["Water-resistant Nylon", "Adjustable webbing strap", "Internal zip pockets"],
    reviews: []
  },
  {
    id: "cs1",
    category: "Cosmetics",
    badge: "Organic",
    name: "Hydrating Velvet Matte Lip Kit",
    price: 1299,
    oldPrice: 1799,
    image: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=600&q=80",
    altImage: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?auto=format&fit=crop&w=600&q=80",
    rating: 4.8,
    ratingCount: 204,
    sizes: ["One Size"],
    colors: [{ name: "Rose Petal", hex: "#C76D7E" }],
    description: "Velvety, long-wearing liquid lipstick paired with a matching lip liner. Infused with coconut oil and Vitamin E.",
    details: ["12-hour transfer-proof wear", "Cruelty-free & Vegan", "Enriched with Vitamin E"],
    reviews: []
  },
  {
    id: "cs2",
    category: "Cosmetics",
    badge: "",
    name: "Rose Quartz Powder Blush Palette",
    price: 1599,
    oldPrice: 1999,
    image: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?auto=format&fit=crop&w=600&q=80",
    altImage: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=600&q=80",
    rating: 4.6,
    ratingCount: 42,
    sizes: ["One Size"],
    colors: [{ name: "Multi-Palette", hex: "#ECC5C8" }],
    description: "Four pigment-rich matte and shimmer shades. Extremely buildable, smooth powder formula for a natural, rosy glow.",
    details: ["Matte and shimmer finishes", "Hypoallergenic and talc-free", "Mirror included"],
    reviews: []
  },
  {
    id: "ac1",
    ...
    badge: "Trending",
    name: "Tulip Aesthetic Shockproof Phone Case",
    price: 799,
    oldPrice: 999,
    image: "https://images.unsplash.com/photo-1576243345690-4e4b79b63288?auto=format&fit=crop&w=600&q=80",
    altImage: "https://images.unsplash.com/photo-1572635196237-14b3f281503f?auto=format&fit=crop&w=600&q=80",
    rating: 4.9,
    ratingCount: 312,
    sizes: ["iPhone 13", "iPhone 14", "iPhone 15"],
    colors: [{ name: "Pastel Pink", hex: "#F3C5CE" }],
    description: "Aesthetic clear cover featuring a hand-painted pink tulip graphic. Extra bumper protection at corners.",
    details: ["Recycled TPU material", "10-foot drop protection", "Wireless charging compatible"],
    reviews: []
  },
  {
    id: "ac2",
    category: "Accessories",
    badge: "Vintage",
    name: "Retro Acetate Tortoise Sunglasses",
    price: 1299,
    oldPrice: 1899,
    image: "https://images.unsplash.com/photo-1572635196237-14b3f281503f?auto=format&fit=crop&w=600&q=80",
    altImage: "https://images.unsplash.com/photo-1576243345690-4e4b79b63288?auto=format&fit=crop&w=600&q=80",
    rating: 4.7,
    ratingCount: 154,
    sizes: ["One Size"],
    colors: [{ name: "Tortoise Gold", hex: "#7E5E39" }],
    description: "Classic 90s rectanglular frames constructed from bio-acetate. Fitted with 100% UVA/UVB protective dark lenses.",
    details: ["Bio-acetate frames", "100% UVA/UVB protection", "Reinforced 5-barrel hinges"],
    reviews: []
  }
];
